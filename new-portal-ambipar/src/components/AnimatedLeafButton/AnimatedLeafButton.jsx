...
const AnimatedLeafButton = ({ label = "Agendar Reunião", onClick }) => {
    return (
        <StyledWrapper>
        <button onClick={onClick}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 208.52 511.88">
                <path
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420.62 554.38">
                <path
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 313.64 405.79">
                <path
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 359.65 724.72">
                <path
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 513.57 1042.57">
                <path
...
const StyledWrapper = styled.div`
    button {
        ...
        border-radius: 12px;
        cursor: pointer;
        box-shadow: 2px 2px 5px #00000033, inset 2px 2px 10px #ffffffb0;
    ...
    button:hover .icon-3 {
        ...
        left: 20%;
        width: 60px;
        animation: inIcon3 1s ease 0.45s forwards;
    }
    @keyframes inIcon3 {
        0% {
        transform: translate(-50%, 0) rotate(0deg);
    ...
    button:hover .icon-4 {
        ...
        left: 10%;
        width: 85px;
        animation: inIcon4 1s ease 0.45s forwards;
    }
    @keyframes inIcon4 {
        0% {
        transform: translate(-50%, 0) rotate(0deg);
    ...
    button:hover .icon-5 {
        ...
        left: 90%;
        width: 85px;
        animation: inIcon5 1s ease 0.45s forwards;
    }
    @keyframes inIcon5 {
        0% {
        transform: translate(-50%, 0) rotate(0deg);
